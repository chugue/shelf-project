...
--  사회
    ...
    (28, '숙론', '/image/book/숙론.jpeg', '224', '최재천 교수가 9년간 집필해 마침내 완성한 역작', '우리 사회의 난제와 이를 해결하기 위한 방법, 저자 자신이 직접 숙론을 이끌었던 사례를 담고 있다.', '사회', '김영사', '/image/epub/숙론.epub', '2024-06-09', NOW(), NOW()),
    (29, '친애하는 슐츠 씨', '/image/book/친애하는_슐츠_씨.jpeg', '384', '어디로 가야 할지 고민하는 이들에게 나침반이 될 수 있는 책', '오래된 편견을 넘어선 사람들의 이야기를 담고 있다.', '사회', '어크로스', '/image/epub/친애하는_슐츠_씨.epub', '2024-06-16', NOW(), NOW()),
    (30, '어떤 동사의 멸종', '/image/book/어떤_동사의_멸종.jpeg', '404', '작가 한승태가 사라지는 직업들의 풍경을 기록한 신작', '인간 사회라는 야생에서멸종되어 가는 몇몇 직업―동사의 이야기', '사회', '시대의창', '/image/epub/어떤_동사의_멸종.epub', '2024-06-23', NOW(), NOW()),
    (31, '선량한 차별주의자', '/image/book/선량한_차별주의자.jpeg', '244', '2019 올해의 책. 평범한 우리 모두가 선량한 차별주의자일 수 있다고 말하는 도발적인 책', '선량한 차별주의자들의 세상에서 평등을 외치는 사람들을 위한 안내서', '사회', '창비', '/image/epub/선량한_차별주의자.epub', '2024-06-22', NOW(), NOW()),
--  종교
...
--  과학
    (41, '당신이 잠든 사이의 뇌과학', '/image/book/당신이_잠든_사이의_뇌과학.jpg', '296', '수백 건의 뇌 수술을 한 신경외과 의사가최신 뇌과학으로 풀어낸 꿈꾸는 뇌의 비밀과 힘!', '인류가 아주 오랫동안 궁금증을 품어왔던 미지의 세계, ‘꿈’을 뇌과학의 시선에서 흥미롭게 분석해낸 책이다. 꿈꾼 사람만이 경험할 수 있는 지극히 개인적인 영역이었던 꿈은 이제 발달된 과학기술로 그 비밀이 하나둘씩 밝혀지기 시작했다. 그동안 베일에 싸여 있었던 ‘꿈’에 얽힌 흥미로운 뇌과학 이야기에 주목해보자.', '과학', '웅진지식하우스', 'image/epub/대화의_힘.epub', '2024-06-02', NOW(), NOW()),
    (41, '내가 처음 뇌를 열었을 때', '/image/book/내가_처음_뇌를_열었을_때.jpg', '296', '건강하게 노후를 보내려면 당장 시작해야 할 두뇌 운동','지금 우리가 알아야 할 뇌에 관한 과학적 사실들을 흥미로운 이야기 속에 담은 교양 에세이.', '과학', '윌북', '/image/epub/대화의_힘.epub', '2024-06-09', NOW(), NOW()),
    (42, '물고기는 존재하지 않는다', '/image/book/물고기는_존재하지_않는다.jpg', '300', '30만 독자의 선택!', '이번 리커버 에디션은 “인생의 의미가 뭐예요?”, “의미는 없어!”라는 의미심장한 책 속 문장에 착안하여, 무의미를 받아들이는 그 공포의 순간을 오래된 도감과 엑스자 기호로 담아내 내놓는다. ', '과학', '곰출판', '/image/epub/대화의_힘.epub', '2024-06-16', NOW(), NOW()),
    (43, '최상의 잠', '/image/book/최상의_잠.jpg', '440', '인생 최대의 실수는 수면 때문에벌어지는 것일지도 모른다!”깊은 잠, 렘수면 단계, 최상의 잠을 이루는 회복의 시간을 위하여', '예일대 의과대학 교수이자 수면 전문가인 메이거 크리거가 잠 때문에 걱정인 사람들을 위해 40년 동안의 수면 연구, 3만 명의 수면 장애 환자 사례를 토대로 쓴 책이다.', '과학', '소용', '/image/epub/대화의_힘.epub', '2024-06-23', NOW(), NOW()),
